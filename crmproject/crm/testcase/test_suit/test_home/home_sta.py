...
class HomeTest(myunit.MyTest):
    ...
    def switch_to_right_frame(self):
        Home(self.driver).switch_my_frame()
    ...
    def test_008_home_verify_title(self):
        ...
        print("推送总数1： ", po.get_text(Home.push_title_loc))
        print("推送总数2： ", globalparam.HOME_PUSH_NUM_TITLE)
        ...
        print("数据来源文本内容： ", po.get_text(Home.guest_gc_ly_loc))
        self.assertEqual(po.get_text(Home.guest_gc_ly_loc), globalparam.HOME_GUEST_LY_TITLE)          # 检验数据来源标题
